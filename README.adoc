...
```
192.168.39.209     ted.local keycloak.ted.local grafana.ted.local kubebox.ted.local jaeger.ted.local prometheus.ted.local cryostat.ted.local
# the ip is from "minikube ip"

```

access the keycloak
http://keycloak.ted.local

access grafana
http://grfana.ted.local
